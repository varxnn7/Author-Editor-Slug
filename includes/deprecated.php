<?php
/**
 * Author Slug Editor Deprecated Functions.
 *
 ...
 * @since 0.9.0
 *
 * @deprecated 1.1.0 Use `vk_ase_auto_update_user_nicename()` instead.
 *
 * @param int $user_id The user id.
 *
 * @return bool|int $user_id. False on failure.
 */
function vk_ase_auto_update_user_nicename_single( $user_id = 0 ) {
	_deprecated_function( __FUNCTION__, '1.1.0', 'vk_ase_auto_update_user_nicename' );
	return vk_ase_auto_update_user_nicename( $user_id );
}
 ...
 */
function vk_ase_get_editable_roles() {
 ...
 */
function vk_ase_update_nicename_cache( $user_id = 0, $old_user_data = '', $new_nicename = '' ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
